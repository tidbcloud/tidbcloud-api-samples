...
from python.create_developer_cluster.main import CreateDeveloperCluster


class TestCreateCluster:
    def setup_method(self):
        self.create_cluster = CreateDeveloperCluster()
    ...
    def setup_cluster(self, setup_region):
        print("setup : create a shared cluster.")
        resp_projects = self.create_cluster.get_all_projects()
        project_id = resp_projects["items"][0]["id"]
        resp_cluster = self.create_cluster.create_developer_cluster(project_id, setup_region)
        ...
        print("success : create a shared cluster.")
        return res
    ...
    def test_create_cluster(self, setup_project, setup_region):
        ...
        resp_body = self.create_cluster.create_developer_cluster(self.project_id, setup_region)
